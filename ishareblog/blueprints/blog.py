...
def index():
    ...
    per_page = current_app.config['ISHAREBLOG_POST_PER_PAGE']
...
def show_post(post_id):
    ...
    if current_user.is_authenticated:
        ...
        form.email.data = current_app.config['ISHAREBLOG_EMAIL']
...
def change_theme(theme_name):
    if theme_name not in current_app.config['ISHAREBLOG_THEMES'].keys():
        abort(404)
